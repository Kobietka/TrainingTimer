...
@Inject constructor(private val completedGoalRepository: CompletedGoalRepository,
    ...
    private val _completionDate = MutableLiveData<String>()
    ...
    fun creationDate(): LiveData<String> {
        return _creationDate
    }

    fun completionDate(): LiveData<String> {
    ...
    private fun loadGoal(id: Int){
        compositeDisposable.add(
            completedGoalRepository.getById(id)
                ...
                .subscribe {
                    ...
                    _completionDate.value = it.completeDate
                    _creationDate.value = it.creationDate
